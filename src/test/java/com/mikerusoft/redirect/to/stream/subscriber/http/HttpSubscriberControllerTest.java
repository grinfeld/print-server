...
class HttpSubscriberControllerTest {
    ...
    private <T, V> FutureEmitter<T> getResultFuture(MutableHttpRequest<V> req, Function<Flowable<HttpRequestWrapper>, T> func) {
        ...
        return new FutureEmitter<>(service, result);
    }
}